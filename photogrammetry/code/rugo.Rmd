...
c1 <- read.csv("../data/rugosity/8.18.20/c1r0-lines.csv", header = F)
c2 <- read.csv("../data/rugosity/8.18.20/c2r0-lines.csv", header = F)
u1 <- read.csv("../data/rugosity/8.18.20/u1r0-lines.csv", header = F)
u2 <- read.csv("../data/rugosity/8.18.20/u2r0-lines.csv", header = F)
z1 <- read.csv("../data/rugosity/8.18.20/z1r0-lines.csv", header = F)
z2 <- read.csv("../data/rugosity/8.18.20/z2r0-lines.csv", header = F)
head(c1)
...
c1ggplot
ggsave("../figures/rugoC1Pre.png", plot = c1ggplot, width = 15, height = 10, units = "in", dpi = 600)
