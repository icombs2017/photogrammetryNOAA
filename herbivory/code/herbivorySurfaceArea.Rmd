...
pacman::p_load("ggplot2","officer","ggpubr", "rcompanion", "RColorBrewer", "patchwork", "magrittr","reshape2", "stringr", "plyr", "dplyr", "flextable", "tidyr", "tibble")
...
totalData <- merge(totalBeforeData, totalAfterData, by = "assay")
...
lossPlot <- ggplot(totalData, aes(x = assay, y = abs(percentChange)))+
                     geom_bar(stat = 'identity')
lossPlot

groupedPlot <- ggplot(totalData, aes(x =))
...
groupPlot <- ggplot(plotData, aes(x = assay, y = area, fill = status))+
